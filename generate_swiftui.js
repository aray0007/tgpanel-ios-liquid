...
// Remove ThemeManager.swift if present to keep it clean and pure
const tmPath = path.join(tgPanelDir, 'ThemeManager.swift');
if (fs.existsSync(tmPath)) fs.unlinkSync(tmPath);

// Pure Transparent Liquid Glass Xcode Project
const pbxproj = `// !$*UTF8*$!
{
	archiveVersion = 1;
	classes = {
...
console.log('✅ Xcode project updated for Pure Transparent Liquid Glass!');
